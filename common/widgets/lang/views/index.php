...
<div class="head">
    <select name="country" class="fastbannerform__country" style="width: 200px">
        <option >请选择</option>
        <option value="ASA" title="AA" >英语</option>
        <option value="CHN" title="CN" >中文</option>
        <option value="DEU" title="DE" >德语</option>
        <option value="FRA" title="FR" >法语</option>
        <option value="RUS" title="RU" >俄语</option>
        <option value="ESP" title="ES" >西班牙语</option>
        <option value="JPN" title="JP" >日语</option>
        <option value="EGY" title="EG" >阿拉伯语</option>
        <option value="KOR" title="KR" >韩语</option>
        <option value="PRK" title="KP" >朝鲜语</option>
        <option value="PRT" title="PT" >葡萄牙语</option>
        <option value="IND" title="IN" >印地语</option>
        <option value="VNM" title="VN" >越南语</option>
        <option value="THA" title="TH" >泰语</option>
