	...
	init: {
		...
		FileUploaded: function(up, file, info) {
            if (info.status == 200)
            {
                ...
                document.getElementById(file.id).getElementsByTagName('b')[0].innerHTML = '<font style="color:green"><b> 上传成功 √ </b></font>';
                document.getElementById(field_input_id).value = filename;
            }
            else
            {
