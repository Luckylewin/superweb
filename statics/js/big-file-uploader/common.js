...
var UP = {
  ...
  __fileInfo: function(self) {
    var $this = $(self);
    var eachSize = this.__input.param.eachSize ? this.__input.param.eachSize : 1024;
    var info = {
      fileThat: $this,
   ...
   * @return   {[type]}   [description]
   */
  __afterSuccess: function(callback) {
    var afterSuccess = this.afterSuccess;
...
UP.__init({
    ...
    ServerUrl:"/admin.php?r=upload%2Fchunk-upload",//服务器地址
